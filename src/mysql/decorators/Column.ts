import {
    ...
    NumericColumnType,
    EnumColumnType
} from "../../postgres/column/ColumnPostgresTypes";
...
import {MetadataReader} from "../../common-rdbms/metadata/MetadataReader";
import {ColumnPostgresOptions} from "../../postgres/column/ColumnPostgresOptions";
 ...
 */
export function Column(options: { type: AllColumnType } & ColumnCommonOptions & ColumnPostgresOptions & ColumnWithLengthOptions & ColumnTimeOptions & ColumnNumericOptions & ColumnEnumOptions): Function;
